...
public class Cliente {
    private String cli_num_doc, cli_telefone, cli_nome, cli_email, cli_numero, cli_bairro, cli_cidade, cli_estado, cli_cep, cli_sexo, cli_dt_nascimento, cli_rua, cli_tipo;
    private int cli_codigo;
    
       
    public String getCli_num_doc() {
        return cli_num_doc;
    }

    public void setCli_num_doc(String cli_num_doc) {
        this.cli_num_doc = cli_num_doc;
    }
    ...
    public String getCli_dt_nascimento() {
        return cli_dt_nascimento;
    }


    public void setCli_dt_nascimento(String cli_dt_nascimento) {
    ...
    public void setCli_Nome(String trim) {
