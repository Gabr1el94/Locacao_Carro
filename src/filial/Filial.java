...
public class Filial {
  private String Fil_cnpj, Fil_telefone, Fil_email, Fil_numero, Fil_rua, Fil_bairro, Fil_cidade, Fil_estado, Fil_cep;   
    ...
    public String getFil_rua() {
        return Fil_rua;
    }


    public void setFil_rua(String Fil_rua) {
        this.Fil_rua = Fil_rua;
    }
